...
.filter__button--geni:hover {
  @apply tw:bg-linear-to-r tw:from-red-500 tw:via-blue-500 tw:to-yellow-500;
}

span.filter__button--genii-bg,
.filter__button--genii:hover {
  @apply tw:bg-linear-to-r tw:from-yellow-600 tw:via-gray-300 tw:to-teal-400;
}

span.filter__button--geniii-bg,
.filter__button--geniii:hover {
  @apply tw:bg-linear-to-r tw:from-red-500 tw:via-blue-500 tw:to-green-500;
}

span.filter__button--geniv-bg,
.filter__button--geniv:hover {
  @apply tw:bg-linear-to-r tw:from-blue-300 tw:via-pink-300 tw:to-gray-400;
}

span.filter__button--genv-bg,
.filter__button--genv:hover {
  @apply tw:bg-linear-to-r tw:from-black tw:to-white;
}

span.filter__button--genvi-bg,
.filter__button--genvi:hover {
  @apply tw:bg-linear-to-r tw:from-blue-600 tw:to-red-600;
}

span.filter__button--genvii-bg,
.filter__button--genvii:hover {
  @apply tw:bg-linear-to-r tw:from-indigo-600 tw:to-orange-600;
}

span.filter__button--genviii-bg,
.filter__button--genviii:hover {
  @apply tw:bg-linear-to-r tw:from-sky-400 tw:to-red-400;
}

span.filter__button--genix-bg,
.filter__button--genix:hover {
  @apply tw:bg-linear-to-r tw:from-red-500 tw:to-violet-500;
}

span.filter__button--redblue-bg,
.filter__button--redblue:hover {
  @apply tw:bg-linear-to-r tw:from-red-500 tw:to-blue-500;
}
